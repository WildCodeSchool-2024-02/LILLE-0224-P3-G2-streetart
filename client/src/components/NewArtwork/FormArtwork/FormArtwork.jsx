...
function FormArtwork() {
  const { image, deletePicture, title, setTitle, handleSubmit } =
    useNewArtwork();
        ...
        <div className="form-artwork">
          <div className="camera-picture">
            <button
              ...
              className="return-camera-btn camera-btn"
            >
              <img
                src="/assets/images/icons/cancel.svg"
                alt="Retourner vers la caméra"
              />
            </button>
          ...
          <div className="field input-title-artwork">
            <input
              ...
              placeholder="Donne un titre à l'oeuvre"
              value={title}
          ...
          <button
            ...
            className="btn send-picture-btn"
          >
            Envoyer
          </button>
        </div>
