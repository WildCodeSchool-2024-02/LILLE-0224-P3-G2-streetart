    ...
    return (
        <div className="login-container">
            ...
            <form onSubmit={handleSubmit} className="login-formulaire">
                ...
                <div className="field">
                    <input className="input-default" type="text" value={email} onChange={handleChangeEmail} placeholder="Saisissez votre adresse mail"/>
                    <div className="line"/>
                </div>
                <div className="field">
                    <input className="input-default" type="text" value={confEmail} onChange={handleChangeConfEmail} placeholder="Confirmez votre adresse mail"/>
                    <div className="line"/>
                </div>
