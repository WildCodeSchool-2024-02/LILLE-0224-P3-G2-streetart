...
import myAxios from "../services/myAxios"
  ...
  function Contact() {
    ...
    const stateStatut = statut === "Votre message a bien été envoyé." ? "state-statut" : "state-statut error"
      ...
      <div className="contact-container">
        ...
        <form className="contact-formulaire" onSubmit={handleSubmit}>
          ...
          <div className="field confidentiality">
            <input type="checkbox" id="confidentialite" value={confidentiality} checked={confidentiality} onChange={() => setConfidentiality(!confidentiality)}/>
